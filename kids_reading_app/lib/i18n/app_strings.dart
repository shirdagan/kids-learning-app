...
class AppStrings {
  ...
  static String appTitle(AppLanguage l) => l.isHebrew ? 'בואו נלמד' : "Let's Learn";

  static String homeTitle(AppLanguage l) => l.isHebrew ? 'בואו נלמד! 🌈' : "Let's Learn! 🌈";
  ...
  static String moduleNumbers(AppLanguage l) => l.isHebrew ? 'מספרים' : 'Numbers';
  static String moduleLetters(AppLanguage l) => l.isHebrew ? 'אותיות' : 'Letters';
  ...
  static String colorsMenuTitle(AppLanguage l) => l.isHebrew ? 'צבעים 🎨' : 'Colors 🎨';
  static String introMenuItem(AppLanguage l) => l.isHebrew ? 'היכרות עם צבעים' : 'Meet the Colors';
  static String findMenuItem(AppLanguage l) => l.isHebrew ? 'מצא את הצבע' : 'Find the Color';
  static String sortMenuItem(AppLanguage l) => l.isHebrew ? 'מיון צבעים' : 'Sort the Colors';

  static String findPrompt(AppLanguage l, String colorName) =>
      l.isHebrew ? 'איפה $colorName?' : 'Where is $colorName?';

  static String sortTitle(AppLanguage l) => l.isHebrew ? 'מיון צבעים 🧺' : 'Sort Colors 🧺';
  ...
  static String celebrationTitle(AppLanguage l) => l.isHebrew ? 'כל הכבוד!' : 'Great job!';
  static String playAgain(AppLanguage l) => l.isHebrew ? 'שוב! 🔁' : 'Again! 🔁';
